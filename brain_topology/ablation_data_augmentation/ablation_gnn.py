...
from ablation_data_augmentation.utils import record_configuration
from ablation_model import GCN, GIN, GAT, VGAE
...
def main():
    ...
    summary_writer, log_dir = get_summary_writer('/home/xuesong/yuxiang_yao/brain_topology/adni_data/run')
