...
def parse_args():
    ...
    parser.add_argument('--train1_loader_type', type=str, default='no_aug_slide_window')
    parser.add_argument('--train2_loader_type', type=str, default='aug_ratio_sample')
    parser.add_argument('--unaug_loader_type', type=str, default='no_aug_no_aug')
