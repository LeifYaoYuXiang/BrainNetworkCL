...
def parse_args():
    ...
    parser.add_argument('--aug_1_method', type=str, default='dropping_node')
    parser.add_argument('--aug_2_method', type=str, default='dropping_edge')
    parser.add_argument('--cl_n_epoch', type=int, default=10)
    parser.add_argument('--n_epoch', type=int, default=200)
    parser.add_argument('--cl_lr', type=float, default=1e-5)
